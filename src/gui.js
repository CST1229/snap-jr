...
IDE_Morph.prototype.snapMenu = function () {
    ...
    menu.addItem(
        "Joecooldoo's News",
        () => window.open('https://joecooldoo.wixsite.com/news', 'SnapWebsite')
    );
    menu.addLine();
    menu.addItem(
        "OG Snap!",
        () => window.open('https://snap.berkeley.edu/snap', 'SnapEditor')
    );
    menu.addItem(
        'Download source',
        () => window.open(
                'https://drive.google.com/drive/folders/16fYKNxuxHltcmt3D7RgjMeDT86NG41S_'
            )
    );
    if (world.isDevMode) {
        menu.addLine();
...
IDE_Morph.prototype.projectMenu = function () {
    ...
    menu = new MenuMorph(this);
    menu.addItem('Edit Description...', 'editProjectNotes');
    menu.addLine();
    menu.addPair('Clear All Code', 'createNewProject', '^N');
    menu.addPair('Open A Snap! Jr. File...', 'openProjectsBrowser', '^O');
...
IDE_Morph.prototype.aboutSnap = function () {
    ...
    aboutTxt = 'Snap! Jr. 1.1.0\nSnap! for Youngsters\n\n'
        + 'Snap! Jr, by Joecooldoo\n'
        + 'Original Snap! by Brian Harvey and Jens Moenig\n'
        + 'Snap! Jr. was developed by joecooldoo.\n'
        + 'Thank you to the original creators of Snap! for making everything free to use!'
    ...
    creditsTxt = localize('Credits')
        + 'Thank you Brian Harvey and Jens Moenig\n'
        + 'For the original version of Snap!';
