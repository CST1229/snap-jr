...
SpriteMorph.prototype.blockColor = {
    motion : new Color(0, 196, 164),
    looks : new Color(0, 219, 114),
    sound : new Color(181, 67, 65),
    pen : new Color(65, 137, 1810),
    control : new Color(163, 0, 155),
    ...
    SpriteMorph.prototype.blocks = {
       ...
       setHeading: {
        ...
        gotoXY: {
            ...
            type: 'command',
            category: 'motion',
            spec: 'go to $arrowLeftRightThin %n , $arrowUpDownThin %n $-2.5',
            defaults: [0, 0]
        },
        doGotoObject: {
            only: SpriteMorph,
         ...
         doGlide: {
            ...
            type: 'command',
            category: 'motion',
            spec: 'glide %n secs to $arrowLeftRightThin %n $arrowUpDownThin %n $-2.5',
            defaults: [1, 0, 0]
        },
        changeXPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'move $arrowLeftRightThin by %n $-2.5',
            defaults: [10]
        },
        setXPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'set $arrowLeftRightThin to %n $-2.5',
            defaults: [0]
        },
        changeYPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'change $arrowUpDownThin by %n $-2.5',
            defaults: [10]
        },
        setYPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'set $arrowUpDownThin to %n $-2.5',
            defaults: [0]
        },
        xPosition: {
            only: SpriteMorph,
            type: 'reporter',
            category: 'motion',
            spec: '$-2.5 $arrowLeftRightThin $-2.5'
        },
       bounceOffEdge: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'if on edge, bounce $-2.5'
        },
        yPosition: {
            only: SpriteMorph,
            type: 'reporter',
            category: 'motion',
            spec: '$-2.5 $arrowUpDownThin $-2.5'
        },
        direction: {
            only: SpriteMorph,
            type: 'reporter',
            category: 'motion',
            spec: '$-2.5 $turnAround $-2.5'
        },
